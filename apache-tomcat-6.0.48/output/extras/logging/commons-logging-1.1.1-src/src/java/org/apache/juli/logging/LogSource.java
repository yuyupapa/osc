 ...
 *     <code>org.apache.juli.logging.impl.NoOpLog</code>.</li>
 * </ul>
 *
 * <p>You can change the default behavior in one of two ways:</p>
 * <ul>
 * <li>On the startup command line, set the system property
 *     <code>org.apache.juli.logging.log</code> to the name of the
 *     <code>org.apache.juli.logging.Log</code> implementation class
 *     you want to use.</li>
...
public class LogSource {
    ...
    static {
        ...
        try {
            if ((null != Class.forName("java.util.logging.Logger")) &&
                (null != Class.forName("org.apache.juli.logging.impl.Jdk14Logger"))) {
            ...
            try {
                ...
                try {
                    setLogImplementation
                            ("org.apache.juli.logging.impl.NoOpLog");
                } catch (Throwable u) {
                    ;
                }
            }
     ...
     * <tt>org.apache.juli.logging.log</tt> property.
     * The value of <tt>org.apache.juli.logging.log</tt> may be set to
     ...
     * <p>
     * When <tt>org.apache.juli.logging.log</tt> is not set,
