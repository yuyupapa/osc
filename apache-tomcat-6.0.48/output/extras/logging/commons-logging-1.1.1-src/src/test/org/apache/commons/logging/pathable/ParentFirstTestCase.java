 ...
 */ 
package org.apache.juli.logging.pathable;
...
public class ParentFirstTestCase extends TestCase {
    ...
    public void testPaths() throws Exception {
        ...
        Class logClass = contextLoader.loadClass("org.apache.juli.logging.Log");
        ...
        Class log4jClass = contextLoader.loadClass("org.apache.juli.logging.impl.Log4JLogger");
        ...
        Class testClass = contextLoader.loadClass("org.apache.juli.logging.PathableTestSuite");
    ...
    public void testResource() {
        ...
        resource = childLoader.getResource("org/apache/juli/logging/Log.class");
        assertNotNull("Unable to locate Log.class resource", resource);
        
        // getResource where it is accessable only to child classloader
        resource = childLoader.getResource("org/apache/juli/logging/PathableTestSuite.class");
        ...
        resource = childLoader.getResource("org/apache/juli/logging/impl/Log4JLogger.class");
    ...
    public void testResources() throws Exception {
        ...
        resources = childLoader.getResources("org/apache/juli/logging/Log.class");
        urls = toURLArray(resources);
        ...
        resources = childLoader.getResources("org/apache/juli/logging/PathableTestSuite.class");
        urls = toURLArray(resources);
        ...
        resources = childLoader.getResources("org/apache/juli/logging/impl/Log4JLogger.class");
        urls = toURLArray(resources);
    ...
    public void testResourceAsStream() throws Exception {
        ...
        is = childLoader.getResourceAsStream("org/apache/juli/logging/Log.class");
