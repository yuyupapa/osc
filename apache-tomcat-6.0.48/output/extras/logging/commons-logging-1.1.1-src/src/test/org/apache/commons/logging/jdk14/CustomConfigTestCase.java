...
import org.apache.juli.logging.DummyException;
...
public class CustomConfigTestCase extends DefaultConfigTestCase {
    ...
    protected static final String HANDLER_NAME 
        = "org.apache.juli.logging.jdk14.TestHandler";
    ...
    public void setUp() throws Exception {
        setUpManager
            ("org/apache/juli/logging/jdk14/CustomConfig.properties");
        ...
        for (int i = 0; i < testMessages.length; i++) {
            ...
            assertTrue("LogRecord class",
                         record.getSourceClassName().startsWith(
                                 "org.apache.juli.logging.jdk14.CustomConfig"));
            if (thrown) {
